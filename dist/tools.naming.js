...
var _, changeCase, creepNamesFuns, lc, nameGenSimple, names1, names2, opm, opmNameFun, p, planetNameFuns;
...
module.exports.genUniqueSpawnName = function() {
  var i, j, name;
  for (i = j = 0; j < 10; i = ++j) {
...
changeCase = function(str) {
  var i, isLetter, j, len, prevIsLetter, v, vs;
  vs = str.split("");
  prevIsLetter = false;
  for (i = j = 0, len = vs.length; j < len; i = ++j) {
    v = vs[i];
